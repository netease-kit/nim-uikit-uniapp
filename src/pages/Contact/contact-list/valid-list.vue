<template>
  <div class="valid-list-container">
    ...
    <div class="valid-list-content">
      ...
      <div v-else class="valid-item" v-for="msg in validMsg" :key="`${msg.idServer}_${msg.from}_${msg.to}_${msg.type}`">

        <template v-if="msg.type === 'applyTeam'">
          <div class="valid-item-left">
            <Avatar :account="msg.attach?.toTeam?.teamId" :team-id="msg.attach?.toTeam?.teamId"
              :avatar="msg.attach?.toTeam?.avatar" />
            <div class="valid-name-container">
              <div class="valid-name">{{ store.uiStore.getAppellation({
                account: msg.attach?.fromUser?.account,
              }) }}</div>
              <div class="valid-action">{{ $t('applyTeamText') + (msg.attach?.toTeam?.name || msg.attach?.toTeam?.teamId)
              }}</div>
            </div>
          </div>
          ...
          <div class="valid-buttons" v-else>
            <div class="valid-button button-reject" @tap="handleRejectApplyTeamClick(msg)" :loading="applyTeamLoaidng">{{
              $t('rejectText') }}</div>
            <div class="valid-button button-accept" @tap="handleAcceptApplyTeamClick(msg)" :loading="applyTeamLoaidng">{{
              $t('acceptText') }}</div>
          </div>
        </template>
        ...
        <template v-else-if="msg.type === 'teamInvite'">
          <div class="valid-item-left">
            ...
            <div class="valid-name-container">
              ...
              <div class="valid-action">{{ $t('inviteTeamText') + (msg.attach?.toTeam?.name || msg.attach?.toTeam?.teamId)
              }}</div>
            </div>
          </div>
          <div v-if="msg.state === 'pass'" class="valid-state">
        ...
        <template v-else-if="msg.type === 'rejectTeamApply'">
          <div class="valid-item-left">
            <Avatar :account="msg.attach?.fromTeam?.teamId" :team-id="msg.attach?.fromTeam?.teamId"
              :avatar="msg.attach?.fromTeam?.avatar" />
            <div class="valid-name-container">
              <div class="valid-name">{{ msg.attach?.fromTeam?.name || msg.attach?.fromTeam?.teamId }}</div>
            </div>
          </div>
        ...
        <template v-else-if="msg.type === 'friendRequest'">
          ...
          <template v-if="msg.attach?.type === 'applyFriend'">
            <div class="valid-item-left">
              <Avatar :account="msg.attach?.fromUser?.account" />
              <div class="valid-name-container">
                <div class="valid-name">{{ store.uiStore.getAppellation({
          ...
          <template v-else-if="msg.attach?.type === 'rejectFriendApply'">
            <div class="valid-item-left">
              <Avatar :account="msg.attach?.fromUser?.account" />
              <div class="valid-name-container">
                <div class="valid-name">{{ store.uiStore.getAppellation({
          ...
          <template v-else-if="msg.attach?.type === 'passFriendApply'">
            <div class="valid-item-left">
              <Avatar :account="msg.attach?.fromUser?.account" />
              <div class="valid-name-container">
                <div class="valid-name">{{ store.uiStore.getAppellation({
