<template>
  ...
  <div class="login-form-container">
    ...
    <div class="login-form">
      <FormInput class="login-form-input" type="tel" v-model="loginForm.mobile" :placeholder="i18n.mobilePlaceholder"
        :allow-clear="true" :rule="mobileInputRule">
        <template #addonBefore>
          <span class="phone-addon-before">+86</span>
        </template>
      </FormInput>
      <FormInput class="login-form-input" type="tel" v-model="loginForm.smsCode" :placeholder="i18n.smsCodePlaceholder"
