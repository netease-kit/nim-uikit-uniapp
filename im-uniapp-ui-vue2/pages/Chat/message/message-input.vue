  ...
  <div>
    <div class="msg-input-wrapper">
      ...
      <div class="msg-button-group">
        ...
        <div class="msg-input-button" @tap="handleSendImageMsg">
          <div v-if="sendingImg" class="msg-input-button msg-input-loading">
            <image class="loading"
              src="https://yiyong-qa.netease.im/yiyong-static/statics/uniapp-vue2-h5/static/icons/icon-a-Frame8.png">
            </image>
          </div>
          <div v-else>
      ...
      <div class="msg-input">
        ...
        <input v-else :focus="isFocus" class="msg-input-input" :maxlength="-1" :placeholder="placeholder"
          v-model="inputText" type="text" :disabled="isTeamMute" :confirm-hold="true" cursor-spacing="20"
          adjust-position="true" confirm-type="send" @confirm="handleSendTextMsg" @blur="handleInputBlur"
          @focus="handleInputFocus" @input="handleInput" id="msg-input" />
      </div>
      <div v-if="extVisible" class="msg-ext" @click.stop="() => { }">
        <Face v-if="emojiVisible" @emojiClick="handleEmoji" @emojiDelete="handleEmojiDelete"
