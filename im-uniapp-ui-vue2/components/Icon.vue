<template>
  <view :class="className" :style="iconStyle">
    <!-- #ifdef APP-PLUS -->
    <image :src="url" :style="{ width: size + 'px', height: size + 'px' }" class="icon" />
    <!-- #endif -->
    <!-- #ifndef APP-PLUS -->
    <img :src="url" :style="{ width: size + 'px', height: size + 'px' }" class="icon" />
    <!-- #endif -->
  </view>
</template>
...
const urlMap = {
  ...
  "icon-shezhi" : "https://yx-web-nosdn.netease.im/common/13469832469783be5c0c3aa6136a3b63/icon-shezhi.png",
